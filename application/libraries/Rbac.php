...
{	
	...
	{
		$controller = $this->obj->uri->segment(1);
		...
		elseif(!$this->check_module_permission($controller)) //sending controller name
		{
	...
	function check_operation_access_new($operation)
	{
		if($this->obj->is_supper){
			return 1;
		}
		elseif(!$this->check_operation_permission($operation))
		{
