...
.select2-container .select2-selection {
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-default">
      <div class="card-header bg-white">
          <div class="d-inline-block">
            <h3 class="card-title">Potongan Pinjaman</h3>
           </div>
           <div class="d-inline-block float-right">
            <a href="<?= base_url("pinjaman"); ?>" class="btn btn-primary btn-sm text-white"><i class="fa fa-reply"></i>  kembali</a>
          </div>
        </div>
    ...
    <?php $this->load->view('admin/includes/_messages.php') ?>
      <?php echo form_open_multipart("pinjaman/potongan/".$transfer['no_bukti']."/".$transfer['kd_pegawai']);?>
         <div class="row">
         <div class="col-md-4">
          ...
          <div class="col-md-4">
            <div class="form-group">
                <label for="area" class="control-label">Pegawai/Rekening</label>
                <input type="text" name="rek_asala" class="form-control" id="rek_asala" value="<?= $transfer['kd_pegawai_asal'];?> -  <?= $transfer['nm_pegawai_asal'];?>" placeholder="No_kas" required readonly>
                <input type="hidden" name="rek_asal" class="form-control" id="rek_asal" value="<?= $transfer['kd_pegawai_asal'];?>" placeholder="No_kas" required readonly>
            </div>
          </div>
          <div class="col-md-4">
            <div class="form-group">
...
document.getElementById("nilai").onkeyup   = function() {hitung()};
    ...
    "processing": true,
    "serverSide": false,
    "ajax": "<?=base_url('pinjaman/datatable_json_rincian_potongan/'.$transfer["no_bukti"])?>",
    "order": [[0,'asc']],
    "columnDefs": [
