      ...
      <div class="card card-default">
        ...
        <?php echo form_open_multipart('spj/edit_keterangan/'.$data_spj["no_spj"].'/'.$data_spj["kd_area"]);?>
         ...
         <div class="col-md-6">
            ...
            <input type="text" name="nm_area" id="nm_area" class="form-control" value="<?= $data_spj["nm_area"] ?>" readonly> 
            <input type="hidden" name="area" id="area" class="form-control" value="<?= $data_spj["kd_area"] ?>" readonly>
            </div>
          </div>
          <div class="col-md-6">
           <div class="form-group">
...
<script>
  $(document).ready(function(){
    ...
    var kdarea      = "<?= $data_spj["kd_area"] ?>";
    var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": false,
    "ajax": "<?=base_url('spj/datatable_json_spj_edit/')?>"+ no_spj+'/'+kdarea,
    "order": [[0,'asc']],
    "columnDefs": [
...
function load_rincian_temp(nospj) {
        var kdaarea      = $('#area').val();

        table.ajax.url("<?=base_url('spj/datatable_json_spj_edit'.'/')?>"+ nospj+'/'+kdaarea);
        table.ajax.reload();
}
...
$('#formtest').submit(function(e){
            ...
            $.ajax({
                url:'<?php echo base_url();?>index.php/spj/simpan_spj_file2',
