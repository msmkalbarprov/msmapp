...
.select2-container .select2-selection {
  ...
  <div class="content-wrapper">
    ...
    <div class="card card-default">
      <div class="card-header bg-white">
          <div class="d-inline-block">
            <h3 class="card-title">Potongan Pengeluaran Lainnya</h3>
           </div>
           <div class="d-inline-block float-right">
            <a href="<?= base_url("pengeluaran_lain"); ?>" class="btn btn-primary btn-sm text-white"><i class="fa fa-reply"></i>  kembali</a>
          </div>
        </div>
    ...
    <?php $this->load->view('admin/includes/_messages.php') ?>
      <?php echo form_open_multipart("pengeluaran_lain/potongan/".$transfer['no_bukti']);?>
         <div class="row">
         <div class="col-md-1">
...
document.getElementById("nilai").onkeyup   = function() {hitung()};
    ...
    "processing": true,
    "serverSide": false,
    "ajax": "<?=base_url('pengeluaran_lain/datatable_json_rincian_potongan/'.$transfer["no_bukti"])?>",
    "order": [[0,'asc']],
    "columnDefs": [
