         ...
         <div class="row">
          <div class="col-md-4">
            <div class="form-group">
              <label for="area" class="control-label">Rekening</label>
...
$('#butcetak').on('click', function() {
    ...
    var url = '<?= base_url() ?>'+'kas_rekening/cetak_kas_rekening/'+area+'/'+tahun+'/1/'+bulan; 
...
$('#butexport').on('click', function() {
    ...
    var url = '<?= base_url() ?>'+'kas_rekening/cetak_kas_rekening/'+area+'/'+tahun+'/0/'+bulan; 
    window.open(url, '_blank');
});
