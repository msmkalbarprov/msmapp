      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('bank/edit/'.$bank['id']), 'class="form-horizontal"' )?> 

              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    <label for="id" class=" control-label">No. Rekening</label>
                    <input type="text" name="no_rekening" value="<?= $bank['no_rekening']; ?>" class="form-control" id="no_rekening"  placeholder="">
                  </div>
                </div>
                <div class="col-md-6">
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input type="text" name="nm_bank" value="<?= $bank['nm_bank']; ?>" class="form-control" id="nm_bank"  placeholder="">
                  </div>
                </div>
                <div class="col-md-6">
