          ...
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <select name="item_op" id="item_op" class="form-control select2" style="width: 100%;" readonly>
                <option value="">No Selected</option>
          ...
          <div class="col-md-6">
           <div class="form-group">
            <label for="tipeproyek" class="control-label">Uraian</label>
              <input type="text" name="uraian" id="uraian" class="form-control"  placeholder="Uraian" readonly>
          </div>
          </div>
         </div>
          ...
          <div class="col-md-3">
            <div class="form-group">
              <label for="DPA/DPPA" class="control-label">Volume</label>
                <input type="number" name="volume" id="volume" class="form-control" placeholder="" readonly>
            </div>
          </div>
          <div class="col-md-3">
           <div class="form-group">
          ...
          <div class="col-md-3">
            <div class="form-group">
              <label for="tanggal2" class="control-label">Harga</label>
                <input type="text" name="harga" id="harga" class="form-control" value="0" style="background:none;text-align:right;" onkeypress="return(currencyFormat(this,'.',',',event))" readonly>
            </div>
          </div>
          <div class="col-md-3">
           <div class="form-group">
