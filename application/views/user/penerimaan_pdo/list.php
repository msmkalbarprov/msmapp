...
<script>
  ...
  var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": false,
    "ajax": "<?=base_url('penerimaan_pdo/datatable_json')?>",
    "order": [[0,'asc']],
    "columnDefs": [
    ...
    { "targets": 4, "name": "tgl_terima", 'searchable':true, 'orderable':false},
    { "targets": 5, "name": "no_terima", 'searchable':true, 'orderable':false},
