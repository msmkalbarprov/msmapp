        ...
        <div class="card-header">
          <div class="d-inline-block">
           ...
           <div class="d-inline-block float-right">
            <a href="<?= base_url('proyek/edit-proyek/'.$proyek["id_proyek"]); ?>" class="btn btn-primary"><i class="fa fa-reply"></i>  kembali</a>
          </div>
        </div>
        <div class="card-body">
         ...
         <?php echo form_open_multipart('ProyekController/addRincian');?>
         <div class="row">
          <div class="col-md-6">
