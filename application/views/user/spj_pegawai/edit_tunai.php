    ...
    <section class="content">
      <div class="card card-default">
        ...
        <?php $this->load->view('admin/includes/_messages.php') ?>
         <?php echo form_open_multipart('spj_tunai/edit_keterangan/'.$data_spj["no_spj"].'/'.$data_spj["kd_pegawai"]);?>
         <div class="row">
          <div class="col-md-4">
...
<script>
  $(document).ready(function(){
    ...
    "processing": true,
    "serverSide": false,
    "ajax": "<?=base_url('spj_tunai/datatable_json_spj_edit/')?>"+ no_spj+'/'+kd_pegawai,
    "order": [[0,'asc']],
    "columnDefs": [
...
$('#jns_spj').change(function(){ 
    ...
    var area        = $("#cbarea").val();  //$("#kd_area").val();
    $.ajax({
...
$('#formtest').submit(function(e){
          ...
          return;
            ...
            $.ajax({
                url:'<?php echo base_url();?>index.php/spj_tunai/simpan_spj_file2',
...
function load_rincian_temp(nospj) {
    ...
    table.ajax.url("<?=base_url('spj_tunai/datatable_json_spj_edit'.'/')?>"+ nospj+'/'+kd_pegawai);
    table.ajax.reload();
}
