        ...
        <?php $this->load->view('admin/includes/_messages.php') ?>
         ...
         <div class="row">
          ...
          <div class="form-group">
                ...
                <input type="hidden" name="<?php echo $this->security->get_csrf_token_name(); ?>" value="<?php echo $this->security->get_csrf_hash(); ?>">
                <input type="text" name="projek" id="projek" class="form-control" value="<?= $data_spj["nm_paket_pekerjaan"]; ?>">
                <input type="hidden" name="kd_projek" id="kd_projek" class="form-control" value="<?= $data_spj["kd_proyek"]; ?>">
              </div>
          </div>
          <div class="col-md-3">
          <div class="form-group">
          ...
          <div class="col-md-6">
           <div class="form-group">
            <label for="tipeproyek" class="control-label">Keterangan</label>
              <textarea type="text" name="keterangan" id="keterangan" rows="1" class="form-control"  value="<?= $data_spj["keterangan"]; ?>" ></textarea>
          </div>
          </div>
         </div>
