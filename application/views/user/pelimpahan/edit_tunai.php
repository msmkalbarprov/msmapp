      ...
      <div class="card card-default color-palette-bo">
        ...
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('tunai/edit/'.$bank['id']), 'class="form-horizontal"' )?> 
            <div class="row">
                <div class="col-md-3">
                  <div class="form-group">
                    <label for="id" class="control-label">No. Kas</label>
                    <input type="text" name="no_kas" value="<?= $bank['no_kas']; ?>"  class="form-control" id="no_kas" placeholder="" readonly>
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
                ...
                <div class="col-md-3">
                  <div class="form-group">
                    ...
                    <input type="date" name="tanggal" id="tanggal" value="<?= $bank['tgl_kas']; ?>" class="form-control">
                  </div>
                </div>
                <div class="col-md-3">
                  <div class="form-group">
