      ...
      <div class="card card-default">
        <div class="card-header">
          <div class="d-inline-block">
            <h3 class="card-title">
             Pembayaran Atas Hutang Tahun Lalu </h3>
           </div>
           <div class="d-inline-block float-right">
            <a href="<?= base_url('pembayaran_hutang_tahun_lalu/add'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>  Tambah</a>
          </div>
        </div>
      <!-- /.box-body -->
      <div class="card-body">
...
//   $("#pembayaran tahun lalu> a").addClass('active');
</script>
<script type="text/javascript">
    var table = $('#na_datatable').DataTable( {
    "processing": true,
    "serverSide": false,
    "ajax": "<?=base_url('pembayaranTahunLalu/datatable_json/')?>",
    "order": [[0,'asc']],
    "columnDefs": [
    ...
    { "targets": 6, "name": "potongan", 'searchable':true, 'orderable':false},
