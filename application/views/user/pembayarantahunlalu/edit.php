      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            <a href="<?= base_url('pembayaran_hutang_tahun_lalu'); ?>" class="btn btn-success"><i class="fa fa-list"></i> List Pelimpahan</a>
          </div>
        </div>
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('pembayaran_hutang_tahun_lalu/edit/'.$bank['id']), 'class="form-horizontal"' )?> 
            <div class="row">
                <div class="col-md-4">
                ...
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <input type="date" name="tanggal" id="tanggal" value="<?= $bank['tgl_bayar']; ?>" class="form-control">
                  </div>
                </div>
                <div class="col-md-4">
                  <div class="form-group">
