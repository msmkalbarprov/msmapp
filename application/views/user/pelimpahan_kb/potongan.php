...
.select2-container .select2-selection {
  ...
  <div class="content-wrapper">
      ...
      <div class="card-header bg-white">
          <div class="d-inline-block">
           ...
           <div class="d-inline-block float-right">
            <a href="<?= base_url("pelimpahan_kb"); ?>" class="btn btn-primary btn-sm text-white"><i class="fa fa-reply"></i>  kembali</a>
          </div>
        </div>
    ...
    <?php $this->load->view('admin/includes/_messages.php') ?>
      <?php echo form_open_multipart("pelimpahan_kb/potongan/".$transfer['no_bukti']);?>
         <div class="row">
         <div class="col-md-1">
...
document.getElementById("nilai").onkeyup   = function() {hitung()};
    ...
    "processing": true,
    "serverSide": false,
    "ajax": "<?=base_url('pelimpahan_kb/datatable_json_rincian_potongan/'.$transfer["no_bukti"])?>",
    "order": [[0,'asc']],
    "columnDefs": [
