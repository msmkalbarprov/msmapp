      ...
      <div class="card card-default">
        <div class="card-header">
          <div class="d-inline-block">
            <h3 class="card-title">
             Pelimpahan Uang Kas Besar</h3>
           </div>
           <div class="d-inline-block float-right">
            <a href="<?= base_url('pelimpahan_kb/add'); ?>" class="btn btn-success btn-sm"><i class="fa fa-plus"></i>  Tambah</a>
          </div>
        </div>
      <!-- /.box-body -->
      <div class="card-body">
...
<script src="<?= base_url() ?>assets/plugins/datatables/dataTables.bootstrap4.js"></script>
  ...
  $("#pelimpahan_kb> a").addClass('active');
</script>
<script type="text/javascript">
    ...
    "processing": true,
    "serverSide": false,
    "ajax": "<?=base_url('pelimpahan_kb/datatable_json/')?>",
    "order": [[0,'asc']],
    "columnDefs": [
