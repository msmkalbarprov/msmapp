        ...
        <div class="card-header">
          <div class="d-inline-block">
            <h3 class="card-title"> <i class="fa fa-print"></i>
				Cetak Rincian Realisasi Proyek Cair PDO</h3>
           </div>
        ...
        $(document).on("click", "#search", function() {
			...
			if (ctahun == '') {
        		...
        		$("#treeview-mdbootstrap").html('<center><img src="<?php echo base_url('assets/img/loading.gif'); ?>" alt="Loading" height="42" width="42"></center>');
			  	$.ajax({
					  url: '<?php echo base_url('laporan-rinci-realisasi-proyek-pdo-prev'); ?>',
					  type: 'POST',
        ...
        $(document).on("click", ".tombol-print", function() {
        	...
        	if (ctahun == '') {
        		...
        		swal.fire({
			  	...
			  	if (id == 'print-pdf') {
			  		window.open('<?php echo base_url('laporan-rinci-realisasi-proyek-pdo-pdf'); ?>/'+ctahun+'/'+carea+'/'+cacc+'/pdf', '_blank');	
			  	}else{
					window.open('<?php echo base_url('laporan-rinci-realisasi-proyek-pdo-excel'); ?>/'+ctahun+'/'+carea+'/'+cacc+'/excel', '_blank');
			  	}
        	}
