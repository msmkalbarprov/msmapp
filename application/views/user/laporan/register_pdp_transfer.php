        ...
        <div class="card-header">
          <div class="d-inline-block">
            <h3 class="card-title"> <i class="fa fa-print"></i>
             Cetak Register pengiriman Dana Proyek </h3>
           </div>
...
$('#butcetak').on('click', function() {
    ...
    var url = '<?= base_url() ?>'+'laporan_pdp_transfer/cetak/'+area+'/'+tahun+'/1/'+bulan; 
...
$('#butexport').on('click', function() {
    ...
    var url = '<?= base_url() ?>'+'laporan_pdp_transfer/cetak/'+area+'/'+tahun+'/0/'+bulan; 
    window.open(url, '_blank');
});
