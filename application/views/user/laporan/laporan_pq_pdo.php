...
$('#butcetak').on('click', function() {
    ...
    if (projek=='all'){
      var url = '<?= base_url() ?>'+'laporan_pq/cetak_pq_pdo_all/'+area+'/'+tahun+'/1/Laporan PQ VS PDO'; 
    }else{
      var url = '<?= base_url() ?>'+'laporan_pq/cetak_pq_pdo_proyek/'+proyek+'/'+tahun+'/1/Laporan PQ VS PDO';   
    }
...
$('#butexport').on('click', function() {
    ...
    if (projek=='all'){
      var url = '<?= base_url() ?>'+'laporan_pq/cetak_pq_pdo_all/'+area+'/'+tahun+'/0/Laporan PQ VS PDO'; 
    }else{
      var url = '<?= base_url() ?>'+'laporan_pq/cetak_pq_pdo_proyek/'+proyek+'/'+tahun+'/0/Laporan PQ VS PDO';   
    }
    window.open(url, '_blank');
});
