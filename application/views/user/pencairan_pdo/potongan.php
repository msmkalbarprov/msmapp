...
.select2-container .select2-selection {
  ...
  <div class="content-wrapper">
      ...
      <div class="card-header bg-white">
          <div class="d-inline-block">
            <h3 class="card-title"> <i class="fa fa-percent"></i>
             Potongan Pencairan PDO </h3>
           </div>
           <div class="d-inline-block float-right">
            <a href="<?= base_url("pencairan_pdo"); ?>" class="btn btn-primary btn-sm text-white"><i class="fa fa-reply"></i>  kembali</a>
          </div>
        </div>
    ...
    <div class="card-body">
      ...
      <?php echo form_open_multipart("pencairan_pdo/potongan/".$transfer['id_pdo']);?>
         <div class="row">
          <div class="col-md-4">
...
document.getElementById("nilai").onkeyup   = function() {hitung()};
    ...
    "processing": true,
    "serverSide": false,
    "ajax": "<?=base_url('pencairan_pdo/datatable_json_rincian_potongan/'.$transfer["id_pdo"])?>",
    "order": [[0,'asc']],
    "columnDefs": [
