    ...
    <div class="card-body">
      <?php echo form_open(base_url('pencairan/detail/'.$proyek['id_proyek']), 'class="form-horizontal"');  ?> 
         ...
         <div class="row">
          ...
          <div class="col-md-3">
                    <label for="infaq" class="control-label">Infaq</label><br>
                    <small>Tidak</small>
                    <input class='tgl-ios tgl_checkbox' id='c_infaq' name="c_infaq"  type='checkbox' />
                    <label for='c_infaq'></label>
                    <small>Ya</small>
                    <input id='s_infaq' name="s_infaq"  type='hidden' />
          </div>
          <div class="col-md-3">
            <div class="form-group">
                <label for="area" class="control-label">Nilai Infaq</label>
...
function get_nomor_urut(area){
  ...
  function get_dinascombo(kdsubarea){ 
    ...
    { "targets": 5, "name": "ppn", 'searchable':true, 'orderable':false},
    { "targets": 6, "name": "pph", 'searchable':true, 'orderable':false},
    { "targets": 7, "name": "infaq", 'searchable':true, 'orderable':false},
    { "targets": 8, "name": "netto", 'searchable':true, 'orderable':false},
 ...
 if ($('#c_infaq').prop('checked') == true){
  ...
  if (nilai_bruto>sisa){
    alert(nilai_bruto+' - '+ sisa + 'Nilai Melebihi Sisa Nilai Proyek');
  }
}
  </script>