    ...
    <section class="content">
      <div class="card card-default">
        <div class="card-header">
          <div class="d-inline-block">
            <h3 class="card-title"> <i class="fa fa-plus"></i>
             Pengesahan PDO Gaji / Transportasi dan Akomodasi</h3>
           </div>
           <div class="d-inline-block float-right">
            <a href="<?= base_url('pengesahan_pdo/gaji'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-reply"></i>  kembali</a>
          </div>
        </div>
        <div class="card-body">
        ...
        <?php $this->load->view('admin/includes/_messages.php') ?>
         <?php echo form_open_multipart('pengesahan_pdo/setuju_pdo/'.$data_pdo["id_pdo"].'/3');?>
         <div class="row">
          <div class="col-md-3">
        ...
        <div class="form-group">
          <div class="col-md-12" align="center">
            <input type="submit" name="submit" id="tombolsimpan" value="Setuju" class="btn btn-primary btn-sm">
          </div>
        </div>
...
function get_projekcombo(){ 
                ...
                $.ajax({
                      url : "<?php echo site_url('pengesahan_pdo/get_pq_projek_gaji_by_area');?>",
                      method : "POST",
                      data : {
                        '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
                        id: kodearea},
...
$('#projek').change(function(){ 
    ...
    $.ajax({
        url : "<?php echo site_url('pengesahan_pdo/get_item_pq_gaji_by_pq');?>",
        method : "POST",
        data : {
          '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
...
//     $.ajax({
//         url : "<?php echo site_url('pengesahan_pdo/get_pq_projek_by_area');?>",
//         method : "POST",
//         data : {
//           '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
//           id: kodearea},
...
$('#butsave').on('click', function() {
    ...
    if(harga==""){
      ...
      $.ajax({
        url: "<?php echo base_url("pengesahan_pdo/edit_pdo_gaji/");?>",
        type: "POST",
        data: {
          '<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>',
          type:1,
