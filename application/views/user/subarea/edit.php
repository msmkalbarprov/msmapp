      ...
      <div class="card card-default color-palette-bo">
        <div class="card-header">
          ...
          <div class="d-inline-block float-right">
            <a href="<?= base_url('sub-area'); ?>" class="btn btn-success"><i class="fa fa-list"></i> List Sub Area</a>
          </div>
        </div>
        <div class="card-body">   
           <!-- For Messages -->
            ...
            <?php echo form_open(base_url('sub-area/edit/'.$subarea['kd_subarea']), 'class="form-horizontal"' )?> 
