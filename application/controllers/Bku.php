...
class Bku extends MY_Controller {
	...
	public function index(){
		...
		$this->load->view('user/bku/cetak_bku', $data);
...
function terbilang($nilai) {
	...
	public function cetak_bku($id=0,$tahun=0,$jenis=0,$bulan=0)
	{	
		$data['list_bku'] 			= $this->bku_model->get_bku($id,$tahun,$bulan);
		...
		switch ($jenis)
        {
            case 1;
			    ...
			    $this->pdf->load_view('user/bku/bku', $data);
                break;
            case 0;
				...
				$html;
               	break;
             case 2;
				$this->load->view('user/bku/bku', $data);
               	break;
        }
